...
export const heroStyles = {
  ...
  itemDot:
    "w-2 h-2 rounded-full bg-blue-500 flex-shrink-0",
  ...
  // Scroll Indicator
scrollIndicator:
  "absolute bottom-8 sm:bottom-10 left-1/2 -translate-x-1/2 z-30",
...
scrollDot:
  "w-1 h-3 bg-gray-400 rounded-full mt-2 animate-scrollWheel"
